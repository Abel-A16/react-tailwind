...
function CardComponent({ imageUrl, title, description }) {
  return (
    <div className='bg-white w-full items-start sm:w-72 md:w-80 lg:w-96 h-auto my-5 mx-auto shadow-md rounded-lg overflow-hidden duration-700 hover:scale-105'>
