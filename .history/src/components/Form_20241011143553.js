...
function Form() {
  return (
    <motion.div
      className='flex flex-col h-screen bg-gray-200 shadow-md mx-auto rounded-xl justify-center items-center w-96 h-96'
    ...
    >
      ...
      <motion.form
        className='flex flex-col justify-between w-full px-4'
      ...
      >
        <label className='flex flex-col my-1'>
          ...
          <motion.input
            ...
            className='rounded-lg border border-gray-400 p-1 mt-1'
            type='text'
        ...
        <label className='flex flex-col my-1'>
          ...
          <motion.input
            ...
            className='rounded-lg border border-gray-400 p-2 mt-1'
            type='email'
            whileFocus={{ scale: 1.05 }}    // Slightly scale the input when focused
          />
        </label>
        ...
        <motion.button
          className='bg-lime-700 rounded-md p-2 w-24 my-2 hover:opacity-80 transition-opacity duration-300'
